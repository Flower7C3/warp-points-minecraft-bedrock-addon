...
export const Warps = () => {
    ...
    const WARP_ICONS = [
        ...
        // Markers
        WarpIcon("Marker_Blue", "special", "markers/blue_marker.png"),
        WarpIcon("Marker_Red", "special", "markers/red_marker.png"),
        WarpIcon("Marker_White", "special", "markers/white_marker.png"),
        WarpIcon("Marker_Yellow", "special", "markers/yellow_marker.png"),
        // X/Target
        WarpIcon("Target_Point", "special", "x/target_point.png"),
        WarpIcon("Target_X", "special", "x/target_x.png"),

        // === MIEJSCA ===
        WarpIcon("Home", "places", "places/Home.png"),
        WarpIcon("Hotel", "places", "places/Hotel.png"),
        WarpIcon("Castle", "places", "places/Castle.png"),
        WarpIcon("Tower", "places", "places/Tower.png"),
        WarpIcon("Lighthouse", "places", "places/Lighthouse.png"),
        WarpIcon("Church", "places", "places/Church.png"),
        WarpIcon("Police", "places", "places/Police.png"),
        WarpIcon("Fire_Brigade", "places", "places/Fire_Brigade.png"),
        WarpIcon("Hospital", "places", "places/Hospital.png"),
        WarpIcon("Government", "places", "places/Government.png"),
        WarpIcon("Bank", "places", "places/Bank.png"),
        WarpIcon("Museum", "places", "places/Museum.png"),
        WarpIcon("School", "places", "places/School.png"),
        WarpIcon("Offices", "places", "places/Offices.png"),
        WarpIcon("Factory", "places", "places/Factory.png"),
        WarpIcon("Warehouse", "places", "places/Warehouse.png"),
        WarpIcon("Beacon", "places", "places/Beacon.png"),
        WarpIcon("Animal_Farm", "places", "places/Animal_Farm.png"),
        WarpIcon("Crop_Farm", "places", "places/Crop_Farm.png"),
        WarpIcon("Mob_Farm", "places", "places/Mob_Farm.png"),
        ...
        WarpIcon("Bed", "tools", "tools/Bed.png"),
        WarpIcon("Crafting", "tools", "tools/Crafting_Table.png"),
        WarpIcon("Furnace", "tools", "tools/Furnace.png"),
        WarpIcon("Campfire", "tools", "tools/Campfire.png"),
        WarpIcon("Chest", "tools", "tools/Chest.png"),
        WarpIcon("Barrel", "tools", "tools/Barrel.png"),
        WarpIcon("Ender_Chest", "tools", "tools/Ender_Chest.png"),
        WarpIcon("Shulker_Box", "tools", "tools/Shulker_Box.png"),
        WarpIcon("Composter", "tools", "tools/Composter.png"),
        WarpIcon("Bell", "tools", "tools/Bell.png"),
        WarpIcon("Anvil", "tools", "tools/Anvil.png"),
        WarpIcon("Enchanting", "tools", "tools/Enchanting_Table.png"),
        WarpIcon("Brewing_Stand", "tools", "tools/Brewing_Stand.png"),
        WarpIcon("Smithing_Table", "tools", "tools/Smithing_Table.png"),
        WarpIcon("Loom", "tools", "tools/Loom.png"),
        WarpIcon("Cartography_Table", "tools", "tools/Cartography_Table.png"),
        WarpIcon("Stonecutter", "tools", "tools/Stonecutter.png"),
        WarpIcon("Grindstone", "tools", "tools/Grindstone.png"),
        WarpIcon("Lodestone", "tools", "tools/Lodestone.png"),
        WarpIcon("Respawn_Anchor", "tools", "tools/Respawn_Anchor.png"),
    ]
